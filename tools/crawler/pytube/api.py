...
from .compat import urlparse, parse_qs, unquote
...
class YouTube(object):
    ...
    def videos(self):
		...
		###################
    def proxy_open(self):
        """scan the website through the proxy"""
        self.proxy = urllib2.ProxyHandler({'https':'127.0.0.1:54364'})
